...
return [
    // Bump this to re-sync system templates in all environments.
    'version' => 1,
    'templates' => [
        [
            'name' => 'Quick Morning Practice',
            'description' => 'A short reset to wake up the spine, hips, and shoulders.',
        ...
        [
            ...
            'description' => 'Grip, back, and shoulder stability for desk posture.',
        ...
        [
            'name' => 'Core & Balance',
            'description' => 'Steady midline work with gentle mobility resets.',
        ...
        [
            ...
            'description' => 'A balanced circuit to build full-body strength.',
            'default_rest_seconds' => 30,
            'is_public' => true,
            'exercises' => [
                ['name' => 'Wrist Mobility', 'duration' => 45, 'rest' => 10],
