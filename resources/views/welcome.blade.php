    ...
    <body class="antialiased theme-nightfall app-shell">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
                <div class="text-center">
                    <h2 class="text-4xl md:text-6xl font-bold text-white mb-8 leading-tight">
                        ...
                        <span class="text-cyan-200/80">Humans need to move.</span>
                    </h2>
        ...
        <div class="py-16">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="space-y-6">
                    <div class="flex items-start gap-4 app-panel rounded-xl p-5">
                        <div class="flex-shrink-0 w-10 h-10 bg-cyan-500/15 rounded-full flex items-center justify-center border border-cyan-400/30">
                        ...
                        <div>
                            ...
                            <p class="text-white/60">Standing up from your chair feels like you're 80. The ache follows you home and keeps you awake at night.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 app-panel rounded-xl p-5">
                        ...
                        <div>
                            ...
                            <p class="text-white/60">Your chest is tight, shoulders rounded. You catch your reflection and barely recognize your own posture.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 app-panel rounded-xl p-5">
                        ...
                        <div>
                            ...
                            <p class="text-white/60">Hours staring at monitors leave your neck stiff. The tension creeps up into headaches that kill your focus.</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start gap-4 app-panel rounded-xl p-5">
                        ...
                        <div>
                            ...
                            <p class="text-white/60">Sitting all day leaves you exhausted. No motivation to exercise. The couch wins every time.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div class="grid md:grid-cols-3 gap-6 text-center">
                    <div class="app-card rounded-xl p-6">
                        <div class="text-4xl font-bold text-rose-300 mb-2">60.3%</div>
                        <p class="text-white/60 text-sm">of desk workers report neck pain</p>
                    </div>
                    <div class="app-card rounded-xl p-6">
                        <div class="text-4xl font-bold text-rose-300 mb-2">59.5%</div>
                        <p class="text-white/60 text-sm">report lower back pain</p>
                    </div>
                    <div class="app-card rounded-xl p-6">
                        <div class="text-4xl font-bold text-rose-300 mb-2">49.6%</div>
                        <p class="text-white/60 text-sm">report shoulder pain</p>
                    </div>
                </div>
                <p class="text-center mt-6 text-xs text-white/40">
                    <a href="https://pmc.ncbi.nlm.nih.gov/articles/PMC9800234" target="_blank" rel="noopener" class="hover:text-white/60 transition-colors">Source: NIH - Prevalence of musculoskeletal pain among computer users</a>
                </p>
            </div>
        </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div class="app-card rounded-2xl p-6">
                        <div class="w-12 h-12 bg-emerald-500/20 border border-emerald-400/30 rounded-lg flex items-center justify-center mb-4">
                    ...
                    <div class="app-card rounded-2xl p-6">
                        <div class="w-12 h-12 bg-cyan-500/20 border border-cyan-400/30 rounded-lg flex items-center justify-center mb-4">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="py-16">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="text-center">
                        <div class="w-16 h-16 bg-emerald-500/20 border border-emerald-400/30 rounded-full flex items-center justify-center mx-auto mb-4">
                            <span class="text-2xl font-bold text-white">1</span>
                        </div>
                        <h3 class="text-xl font-semibold text-white mb-2">Pick a Template</h3>
                        <p class="text-white/60">Choose a back-focused routine or start with full body basics.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-white/60">Follow the timer through each exercise. 15 minutes and you're done.</p>
                    </div>
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-white/60">Track your streak and watch your consistency grow day by day.</p>
                    </div>
                </div>
            </div>
        </div>
